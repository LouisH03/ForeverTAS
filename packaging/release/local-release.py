...
- Browse actions use the Linux and Windows system file pickers, fixed numeric displays retain their trailing zeroes, and packaged transport controls retain their intended silhouettes.
